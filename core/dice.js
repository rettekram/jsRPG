...
(function (jsRPG) {
	 ...
	 * 
	 */
	jsRPG.Dice.prototype.rollDice = function (numberOfDice, numberOfSides, adjustValue) {
		// declare variables
		var resultOfDice = [], 
				valueOfDice = [], 
				outputOfDice = "", 
	 ...
	 * 
	 */
	jsRPG.Dice.prototype.parseDice = function (diceRegEx) {
		// declare variables
		var diceArray = [];
	 ...
	 * 
	 */
	jsRPG.Dice.prototype.checkResult = function (resultOfRoll, targetRoll) {
		// delcare variables
		var isSuccess, 
				resultText = "";
